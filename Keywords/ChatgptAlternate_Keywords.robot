...
Click Chat with docs
    Wait Until Page Contains Element    ${CHAT_WITH_DOCS}
    Element Should Be Visible       ${CHAT_WITH_DOCS}
    Sleep   1s
    Wait Until Page Contains Element    ${CHAT_WITH_DOCS_LOGO}
    Element Should Be Visible       ${CHAT_WITH_DOCS_LOGO}
    Sleep   1s
    Click Element   ${CHAT_WITH_DOCS}
    Wait Until Location Is      ${CHAT_WITH_DOCS_URL}       timeout=5s
    Location Should Be      ${CHAT_WITH_DOCS_URL}
    Sleep   1s

Verify Chat with docs and logo presence in subpage
    Wait Until Page Contains Element    ${CHAT_WITH_DOCS_IN_SUBPAGE}
    Element Should Be Visible      ${CHAT_WITH_DOCS_IN_SUBPAGE}
    Sleep    2s
    Wait Until Page Contains Element    ${CHAT_WITH_DOCS_LOGO_IN_SUBPAGE}
    Element Should Be Visible       ${CHAT_WITH_DOCS_LOGO_IN_SUBPAGE}
    Sleep   2s
...
Click Chat with script
    Wait Until Page Contains Element    ${CHAT_WITH_SCRIPT}
    Element Should Be Visible       ${CHAT_WITH_SCRIPT}
    Sleep   1s
    Wait Until Page Contains Element    ${CHAT_WITH_SCRIPT_LOGO}
    Element Should Be Visible       ${CHAT_WITH_SCRIPT_LOGO}
    Sleep   1s
    Click Element   ${CHAT_WITH_SCRIPT}
    Wait Until Location Is      ${CHAT_WITH_SCRIPT_URL}       timeout=5s
    Location Should Be      ${CHAT_WITH_SCRIPT_URL}
    Sleep   1s

Verify Chat with script and logo presence in subpage
    Wait Until Page Contains Element    ${CHAT_WITH_SCRIPT_IN_SUBPAGE}
    Element Should Be Visible      ${CHAT_WITH_SCRIPT_IN_SUBPAGE}
    Sleep    2s
    Wait Until Page Contains Element    ${CHAT_WITH_SCRIPT_LOGO_IN_SUBPAGE}
    Element Should Be Visible       ${CHAT_WITH_SCRIPT_LOGO_IN_SUBPAGE}
    Sleep   2s
...
Click Buffer Memory
    Wait Until Page Contains Element    ${BUFFER_MEMORY}
    Element Should Be Visible       ${BUFFER_MEMORY}
    Sleep   1s
    Wait Until Page Contains Element    ${BUFFER_MEMORY_LOGO}
    Element Should Be Visible       ${BUFFER_MEMORY_LOGO}
    Sleep   1s
    Click Element   ${BUFFER_MEMORY}
    Wait Until Location Is      ${BUFFER_MEMORY_URL}       timeout=5s
    Location Should Be      ${BUFFER_MEMORY_URL}
    Sleep   1s


Verify Buffer Memory and logo presence in subpage
    Wait Until Page Contains Element    ${BUFFER_MEMORY_IN_SUBPAGE}
    Element Should Be Visible      ${BUFFER_MEMORY_IN_SUBPAGE}
    Sleep    2s
    Wait Until Page Contains Element    ${BUFFER_MEMORY_LOGO_IN_SUBPAGE}
    Element Should Be Visible       ${BUFFER_MEMORY_LOGO_IN_SUBPAGE}
    Sleep   2s

Click Summary Buffer
    Wait Until Page Contains Element    ${SUMMARY_BUFFER}
    Element Should Be Visible       ${SUMMARY_BUFFER}
    Sleep   1s
    Wait Until Page Contains Element    ${SUMMARY_BUFFER_LOGO}
    Element Should Be Visible       ${SUMMARY_BUFFER_LOGO}
    Sleep   1s
    Click Element   ${SUMMARY_BUFFER}
    Wait Until Location Is      ${SUMMARY_BUFFER_URL}       timeout=5s
    Location Should Be      ${SUMMARY_BUFFER_URL}
    Sleep   1s


Verify Summary Buffer and logo presence in subpage
    Wait Until Page Contains Element    ${SUMMARY_BUFFER_IN_SUBPAGE}
    Element Should Be Visible      ${SUMMARY_BUFFER_IN_SUBPAGE}
    Sleep    2s
    Wait Until Page Contains Element    ${SUMMARY_BUFFER_LOGO_IN_SUBPAGE}
    Element Should Be Visible       ${SUMMARY_BUFFER_LOGO_IN_SUBPAGE}
    Sleep   2s
...
Click Voice Assistant
    Wait Until Page Contains Element    ${VOICE_ASSISTANT}
    Element Should Be Visible       ${VOICE_ASSISTANT}
    Sleep   1s
    Wait Until Page Contains Element    ${VOICE_ASSISTANT_LOGO}
    Element Should Be Visible       ${VOICE_ASSISTANT_LOGO}
    Sleep   1s
    Click Element   ${VOICE_ASSISTANT}
    Wait Until Location Is      ${VOICE_ASSISTANT_URL}       timeout=5s
    Location Should Be      ${VOICE_ASSISTANT_URL}
    Sleep   1s


Verify Voice Assistant and logo presence in subpage
    Wait Until Page Contains Element    ${VOICE_ASSISTANT_IN_SUBPAGE}
    Element Should Be Visible      ${VOICE_ASSISTANT_IN_SUBPAGE}
    Sleep    2s
